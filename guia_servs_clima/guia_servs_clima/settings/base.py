"""
Django settings for guia_servs_clima project.
...
# Link para o fórum Guia Service Clima
LINK_FORUM = os.getenv('LINK_FORUM')
...
INSTALLED_APPS = [
    ...
    'django_filters',
    'municipios',
    'guia_servs_clima.core',
    'guia_servs_clima.guia_servs_clima',
    'widget_tweaks',
]
SITE_ID = 1
...
ROOT_URLCONF = 'guia_servs_clima.urls'
...
WSGI_APPLICATION = 'guia_servs_clima.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / 'guia_servs_clima/static',
]
